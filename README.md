...
For example: predicting house price , predicting temperature , predicting sales amount
...
## Model Accuracy Comparison without PCA
 Decision Tree	20.70%  ,  Logistic Regression	48.18%  ,  KNN (K-Nearest Neighbors)	31.25%  ,  Random Forest	48.83%  ,  SVM (Support Vector Machine)	58.20%
 
## with PCA (Principal Component Analysis) Algorithm	Accuracy :
Decision Tree + PCA	45.44%  ,  logistic Regression + PCA	25.39%  ,  KNN + PCA	46.88%  , Random Forest + PCA	57.94%  ,  SVM + PCA	40.23% . 
